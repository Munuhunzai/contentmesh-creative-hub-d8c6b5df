      ...
      >
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-center">
          ...
          <div className="flex flex-wrap gap-3 lg:justify-end">
            <Link to="/contact" className="group inline-flex items-center gap-2 rounded-full px-6 py-3.5 text-sm font-semibold text-white transition-transform hover:scale-[1.03]" style={{ background: "linear-gradient(135deg, #FF5A1F 0%, #FF7A00 100%)", boxShadow: "0 4px 24px rgba(255,90,31,0.45)" }}>
