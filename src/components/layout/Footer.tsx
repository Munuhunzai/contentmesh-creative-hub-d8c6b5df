    ...
    <footer className="relative mt-24 border-t border-border/60 bg-secondary/40">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          ...
          <FooterCol title="Company" links={[["About Us", "/about"], ["Portfolio Showcase", "/portfolio"], ["Creative Blog", "/blog"], ["Contact Us", "/contact"]]} />
          <FooterCol title="Services" links={[["AI Video Production", "/services"], ["AI Animation", "/services"], ["AI Voiceovers", "/services"], ["Motion Graphics", "/services"]]} />
